<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('getIndex')}}">
        <div class="sidebar-brand-icon rotate-n-15">
            <i class="fas fa-laugh-wink"></i>
        </div>
        <div class="sidebar-brand-text mx-3">ADMIN<sup>2</sup>
        </div>
    </a>
    <!-- Divider -->
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="{{route('getIndex')}}">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('getListProduct')}}">Danh sách</a>
                <a class="collapse-item" href="{{route('getAddProduct')}}">Thêm mới</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="producttype" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('getList')}}">Danh sách</a>
                <a class="collapse-item" href="{{route('getAdd')}}">Thêm mới</a>
            </div>
        </div>
    </li>
    <hr class="sidebar-divider">
    ...
    <li class="nav-item">
        ...
        <div id="product" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('listAccount')}}">Danh sách</a>
            </div>
        </div>
    </li>
</ul>
