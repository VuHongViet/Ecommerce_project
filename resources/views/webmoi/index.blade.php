...
<div class="container-fluid">
        <div class="container" id="product-header">
            <div>
                <i class="fa fa-list-alt" style="padding-right: 5px;font-weight:bold;"></i>
...
<div class="container-fluid" id="product-list" style="position: relative; ">
    <div class="container">
        <div class="row">
                            ...
                            <div class="col-sm-3 item-product">
                                <div class="grid" class="item-img">
                                    <figure class="effect-zoe">
                                        <a href="{{str_replace('?','/',route('getChitietsanpham',$product[$key]['id']))}}"><img src="{{ asset('resources/upload/product/'.$product[$key]['image']) }} " alt="img25"/></a>
                                        <figcaption>
                                            <p>
                                                <span><a href="{{route('addCart',$product[$key]['id'])}}">Mua ngay</a></span>
                                            </p>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="item-name">
                                    <span style="color:black;"></span> <a href="#" style="color:red;"> {{$product[$key]['name']}}</a>
                                </div>
                                <div class="item-price">
                                    <span class="new-price">{{number_format($product[$key]['price'],0,',','.')}}VND</span>
                                </div>
                                <div class="item-price">
                                    <span class="new-price" style="color:black;">|{{$product[$key]['intro']}}</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="col-sm-3" id="right">
                <div class="container-fluid" id="menu-right" style="border:3px solid black;">
                    <div class="row">
                        <div class="col-sm-12">
    ...
    <div class="container" id="container" >
        <div class="col-xs-12" >{{$product->links()}}</div>
    </div>
